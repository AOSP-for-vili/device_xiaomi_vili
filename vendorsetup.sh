...
git clone https://gitlab.com/0mar99/proprietary_vendor_xiaomi_camera.git vendor/xiaomi/camera

# Dolby Atmos
echo 'Cloning Dolby repo'
git clone https://github.com/AOSP-for-vili/vendor_xiaomi_dolby.git -b 15 vendor/xiaomi/dolby
